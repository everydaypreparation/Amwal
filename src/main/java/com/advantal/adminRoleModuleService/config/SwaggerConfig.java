package com.advantal.adminRoleModuleService.config;
...
//
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
				...
				.apis(RequestHandlerSelectors.basePackage("com.advantal.adminRoleModuleService.controller")).paths(PathSelectors.any()).build();
	}
