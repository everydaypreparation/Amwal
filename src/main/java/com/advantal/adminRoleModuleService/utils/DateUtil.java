...
//		String age = period.getYears() + " Years " + period.getMonths() + " Months";
	...
	public static long differenceBetweenDate(Date generateDate, String currentDate) throws ParseException {
		SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
//		Date date1 = formatter.parse(generateDate);
		Date date2 = formatter.parse(currentDate);
		long differenceInTime = date2.getTime() - generateDate.getTime();
