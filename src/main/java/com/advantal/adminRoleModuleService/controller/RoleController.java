...
public class RoleController {
	...
	public Map<String, Object> getAllRole(@RequestParam Integer pageIndex, @RequestParam Integer pageSize,
			@RequestParam(required = false) String searchText) {
		HashMap<String, Object> map = new HashMap<>();
		 if (pageIndex!= null && pageSize != null) {
			return roleService.getAllRole(pageIndex, pageSize, searchText);
		} else {
			map.put(Constant.RESPONSE_CODE, Constant.BAD_REQUEST);
			map.put(Constant.MESSAGE, Constant.BAD_REQUEST_MESSAGE);
			return map;
